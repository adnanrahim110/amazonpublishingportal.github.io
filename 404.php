...
<html lang=en>
  <head>
    ...
    <title>404 | Amazon Publishing Portal</title>
    <meta name="description" content="">
    <meta name="keywords" content="">
    <link rel="canonical" href="https://amazonpublishingportal.com/404">
    <!-- Stylesheets -->
...
<section class="thankyou error">
<div class=container>
<div class=thankyou-content>
<img src=assets/images/404.png>
</div>
<div class=thankyou-btn>
<a class=pulse-button href=https://amazonpublishingportal.com/ >Back to Home</a>
</div>
</div>
</section>
    ...
    <div class=row>
      <div class=col-md-9>
        <form action=/sendmail.php method=post class=validate-letsget>
          <div class=row>
            <div class=col-md-6>
            	<input type="hidden" name="404" value="" />
				<input type="hidden" name="https://amazonpublishingportal.com/404" value="" />
